...
def main():
    ...
    myenv.docker.base_image = "esterakot/detectron2:latest"
    myenv.python.user_managed_dependencies = True

    myenv.inferencing_stack_version = os.environ.get(
        "ENV_BASE_IMAGE_REPO_VERSION")  # This will install the scoring specific apt packages.
